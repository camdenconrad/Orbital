//! Rendering, camera and the egui application shell.

use crate::bodies::{BodyId, ALL_BODIES, AU_KM, DAY_S};
use crate::chrome;
use crate::dynamics::{self, DynamicsConfig, ScState};
use crate::ephemeris::{self, Ephemeris};
use crate::mission::{load_mission, save_mission};
use crate::porkchop;
use crate::render::{Camera, LineVertex, Scene, SceneCallback, SphereInstance};
use crate::solver::{self, Engine, Launcher, MissionType, Objective, SolverConfig};
use crate::theme;
use glam::Vec3;
...
pub struct App {
    ...
    pub gpu: Option<(Arc<eframe::egui_wgpu::wgpu::Device>, Arc<eframe::egui_wgpu::wgpu::Queue>)>,
...
impl App {
    pub fn new(auto: Option<(SolverConfig, Option<Epoch>)>) -> Self {
